...
@section('content')
    ...
    <div class="card col-span-4 xl:col-span-1">
        <div class="card-header flex justify-between items-center">
            <h2>Categoris</h2>
            <a href=" {{ route('category.create') }} " class="btn-shadow">Add Category</a>
        </div>
        ...
        <table class="table-auto w-full text-left">
            ...
            <tbody class="text-gray-600">
                ...
                <tr>
                    {{-- <td class="border border-l-0 border-b-0 px-4 py-2 capitalize"> {{ $problem->user_id }} </td> --}}
                ...
                @empty
                <tr>
                    <td class="border border-l-0 border-b-0 px-4 py-2 text-center text-red-500" colspan="5">No Categoris Found</td>
